...
// NOTE: These constants are reserved for future rate limiting functionality
// and are not currently used by the library. They will be enabled in a future
// version when rate limiting is implemented.
const (
